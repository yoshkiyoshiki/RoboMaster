...
#include "kinetis_flexcan_comm.h"
...
// -------------------------------------------------------------
FlexCANComm::FlexCANComm(uint32_t baud)
{
...
// -------------------------------------------------------------
void FlexCANComm::begin(const CAN_filter_t &mask)
{
  FLEXCAN0_RXMGMASK = 0;
...
// -------------------------------------------------------------
void FlexCANComm::setFilter(const CAN_filter_t &filter, uint8_t n)
{
  if ( 8 > n ) {
    if (filter.ext) {
...
// -------------------------------------------------------------
int FlexCANComm::available(void)
{
...
// -------------------------------------------------------------
int FlexCANComm::read(CAN_message_t &msg)
{
...
// -------------------------------------------------------------
int FlexCANComm::write(const CAN_message_t &msg)
{
  unsigned long int startMillis;
